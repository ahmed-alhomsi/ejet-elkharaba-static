            ...
            if ($inspiroSlider.length > 0) {
                ...
                function start_kenburn(elem) {
                    ...
                    if (currentSlideKenburns) {
                        currentSlide.find(".kenburns-bg").addClass("Z-OUT");
                        setTimeout(function () {
                ...
                function stop_kenburn(elem) {
                    ...
                    notCurrentSlide
                        .find(".kenburns-bg")
                        .removeClass("kenburns-bg-animate Z-OUT");
                }
                    ...
                    elem.submit(function (event) {
                        ...
                        if (elem[0].checkValidity() === false) {
                            ...
                            var data = $(event.target).serializeArray().reduce(function (obj, item) {
                                ...
                                return obj;
                            }, {}); // returns object of inputs submitted
                            $.ajax({
                                url: post_url,
                                type: request_method,
                                ...
                                cache: false,
                                crossDomain: true,
                                dataType: elem.data('datatype') || 'json',
                                contentType: elem.data('contenttype') || false,
                                processData: false,
                                success: function (response) {
                                    ...
                                    if (response.response == "success" || response.ok) {
                                        ...
                                        // } else {
                                        let message = elem.attr('data-success-message') || response.message || "Done";
                                        INSPIRO.elements.notification(
                                            message,
                                            response.message || "Form is submitted successfully",
                                            "success"
                                        );
                                    } else {
                                        if (elem.find(".g-recaptcha").children("div").length > 0) {
                                        ...
                                        $.notify({
                                            message: elem.attr("data-error-message") || response.message || "Failed to submit form :(",
                                        }, {
                                            type: "danger",
